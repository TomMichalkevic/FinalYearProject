// Referenced code from http://wiki.unity3d.com/index.php/TerrainPerlinNoise

using UnityEditor;
using UnityEngine;
using System.Collections;
 
public class TerrainGenerator : ScriptableWizard
{
    ...
    {
        ScriptableWizard.DisplayWizard("Perlin Noise Generation Wizard", typeof(TerrainGenerator));
    }
